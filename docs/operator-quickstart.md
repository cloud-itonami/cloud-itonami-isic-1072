# Operator Quickstart — Sugar Manufacturing Coordination

Shortest path from clone to a verified local dry-run for **ISIC 1072** (`cloud-itonami-isic-1072`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1072.git
cd cloud-itonami-isic-1072
```
...
- Blueprint governor key: `sugarops-governor`
- Likely source path: `sugarops.governor.cljc`
