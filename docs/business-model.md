# Business Model: Sugar Manufacturing Coordination
...
## Classification
- Repository: `cloud-itonami-isic-1072` ([github.com/cloud-itonami/cloud-itonami-isic-1072](https://github.com/cloud-itonami/cloud-itonami-isic-1072))
- ISIC Rev.5: `1072` — Sugar Manufacturing Coordination
- Domain: `:food/sugar-manufacturing`
- Social impact: :food-security :food-safety :fair-labor
- Actor: `:sugarops-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :food/sugar-manufacturing — who wants
...
Capability stack (required): :robotics :identity :forms :dmn :bpmn :audit-ledger :cae. Optional: :optimization :telemetry.
...
One managed tenant (:food/sugar-manufacturing):
...
- Do not bypass the `:sugarops-governor` for production decisions.
