(ns sugarops.store
  "Store abstraction for sugar-manufacturing production batches. Current
  ...
  A production batch is the minimal unit of work: one refining run of a
  sugar product, tracked from cane/beet intake through extraction,
  clarification, crystallization, inspection, and shipment.
  Representative batch keys:
    - :product-type keyword product id (see `sugarops.facts/product-types`)
    - :jurisdiction keyword jurisdiction id (see `sugarops.facts/jurisdictions`)
    - :moisture-percent / :polarization-percent / :color-icumsa /
      :ash-content-percent / :granulation-microns / :so2-ppm
